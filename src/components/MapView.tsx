...
const CLEAN_MAP_STYLES: google.maps.MapTypeStyle[] = [
  ...
  { featureType: 'poi', elementType: 'geometry', stylers: [{ visibility: 'on' }, { color: '#f1f5f9' }] },
  { featureType: 'poi.attraction', elementType: 'geometry', stylers: [{ visibility: 'on' }, { color: '#e8edf4' }] },
  { featureType: 'poi.business', stylers: [{ visibility: 'off' }] },
  { featureType: 'poi.government', elementType: 'geometry', stylers: [{ visibility: 'on' }, { color: '#e8edf4' }] },
  { featureType: 'poi.place_of_worship', elementType: 'geometry', stylers: [{ visibility: 'on' }, { color: '#e8edf4' }] },
